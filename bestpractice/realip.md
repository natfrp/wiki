...
高版本(1.21.X)可以使用[ProxyProtocolDetector](https://github.com/melodytik/ProxyProtocolDetector)。- 它实现了在paper端开启Proxy Protocol协议时允许任意ip(包括外网)直连服务器 - 对于有公网ipv6的服务器配合DDNS使用极其有用。
