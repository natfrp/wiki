...
若它不适用于您的使用环境，请移步 [Java 版开服指南](/offtopic/mc-java-server.html) 页面或 [Minecraft 基岩版开服指南](/offtopic/mc-bedrock-server.html) 页面。
...
1. JDK 运行环境 [下载](https://www.oracle.com/java/technologies/downloads)
   | 较低版本的 Java 版服务端可能需要 JDK16、JDK8 等历史版本，请参阅 [Java 版服务端文档](/offtopic/mc-java-server.html)
