...
1. 请于 [GitHub Release](https://github.com/natfrp/auth-guest/releases/latest) 或 [Nyatwork CDN](https://nya.globalslb.net/natfrp/client/auth-guest/latest/) 按照您的系统和架构下载程序。
