...
::: warning
我们并不推荐您长期使用 Minecraft 局域网联机 功能，  
如果您希望长期与一群人共同游玩，使用单独的服务端可以为您提供更多的功能和更好的性能。

如果您的电脑配置较低，请不要认为局域网联机可以为您带来比开服更高的性能，其本质与开服无异，甚至 **优化更糟**。
:::
...
因为端口号不固定，每次 **重启游戏后**，您都需要到隧道编辑界面中重新将新的端口填入到 **本地端口**中。
:::
...
成功获取到端口号后，我们就可以开始 [创建隧道](/app/mc.html#create-tunnel) 了。
...
如果采用复制的方式防止地址出错，请注意地址外面的括号 \[\] 是不需要的。请复制 **括号内** 的内容给客机连接。
:::
...
如果您没有使用 mod 或者新版游戏固定地址，请在 **每次重新启动游戏后**，使用隧道编辑修改 **本地端口** 到您游戏中显示的新端口号，再启动隧道：

![](_images/mc-edit-tunnel-btn.png)
